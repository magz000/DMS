...
public class SharedDocumentToMeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shared_to_me);
        ...
        final RealmResults<DocumentShared> documentUploadedFiles = realm.where(DocumentShared.class).equalTo("userIdSharedWith", user.getUserId().trim()).findAllAsync();
        documentUploadedFiles.addChangeListener(new RealmChangeListener<RealmResults<DocumentShared>>() {
            ...
            public void onChange(RealmResults<DocumentShared> element) {
                recyclerView.setLayoutManager(new LinearLayoutManager(SharedDocumentToMeActivity.this));
                recyclerView.setAdapter(new DocumentSharedAdapter(SharedDocumentToMeActivity.this, documentUploadedFiles, toolbar.getTitle().toString()));
    ...
    public void doSearch(String text) {
        final RealmResults<DocumentShared> documentUploadedFiles = realm.where(DocumentShared.class)
                ...
                .or()
                .contains("userIdSharedBy", text, Case.INSENSITIVE).findAll()
    ...
    public void getSharedDocuments(String user_id) {
        ...
        apiInterface.getSharedDocumentsWith(user.getU(),user.getS(), ParameterEncryption.getSharedDocumentsWith(user_id)).enqueue(new Callback<List<DocumentShared>>() {
            @Override
            public void onResponse(Call<List<DocumentShared>> call, final Response<List<DocumentShared>> response) {
                ...
                if (response.isSuccessful()) {
                    try {
                            ...
                            realm.executeTransactionAsync(
                                    new Realm.Transaction() {
                                        ...
                                        public void onError(Throwable error) {
                                            ...
                                            Toast.makeText(SharedDocumentToMeActivity.this, "Failed", Toast.LENGTH_SHORT).show();
                                        }
                                    }
                        ...
                        e.printStackTrace();
                        progressDialog.dismiss();
                        Toast.makeText(SharedDocumentToMeActivity.this, R.string.oops, Toast.LENGTH_SHORT).show();
                    }
                } else {
                    progressDialog.dismiss();
                    Toast.makeText(SharedDocumentToMeActivity.this, R.string.oops, Toast.LENGTH_SHORT).show();
